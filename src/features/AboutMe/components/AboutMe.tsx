...
const AboutMe = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={transitionTop} className="max-w-[40rem] p-4">
        ...
        <p className="text-xl md:text-lg mt-3">
          ...
          handball, tennis and padel being my favourites. For any job
          opportunities, projects or if you just want to chat, feel free to{" "}
          <span className="text-[#8a2be2] font-semibold">
            <a
